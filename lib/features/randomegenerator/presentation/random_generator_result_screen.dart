...
class RandomGeneratorResultScreen extends StatefulWidget {
  const RandomGeneratorResultScreen({Key? key}) : super(key: key);

  @override
  _RandomGeneratorResultScreenState createState() =>
      _RandomGeneratorResultScreenState();
}

class _RandomGeneratorResultScreenState
    extends State<RandomGeneratorResultScreen> {
